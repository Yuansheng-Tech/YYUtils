...
export class TaroStorage implements Storage {
  ...
  /**
   * Returns the name of the nth key in the list, or null if n is greater than or equal to the number of key/value
   * pairs in the object.
   */
  ...
  /**
   * Removes the key/value pair with the given key from the list associated with the object, if a key/value pair with
