  ...
  THREE.GLTFLoader = (function () {
    ...
    function GLTFMaterialsPbrSpecularGlossinessExtension() {
      return {
        ...
        /**
         * Clones a GLTFSpecularGlossinessMaterial instance. The ShaderMaterial.copy() method can copy only properties
         * it knows about or inherits, and misses many properties that would normally be defined by MeshStandardMaterial.
         *
         * This method allows GLTFSpecularGlossinessMaterials to be cloned in the process of loading a glTF model, but
         * cloning later (e.g. by the user) would require these changes AND also updating `.onBeforeRender` on the parent mesh.
         *
     ...
     * @param {number} index
     * @returns {Promise<
     *   THREE.Object3D | THREE.Material | THREE.Texture | THREE.AnimationClip | ArrayBuffer | Object
     * >}
     */
     ...
     * @returns {Promise<THREE.BufferAttribute | THREE.InterleavedBufferAttribute>}
     */
    ...
    /**
     * Assigns final material to a Mesh, Line, or Points instance. The instance already has a material (generated from
     * the glTF material options alone) but reuse of the same glTF material may require multiple threejs materials to
     * accomodate different primitive types, defines, etc. New materials will be created if necessary, and reused from a cache.
     *
     ...
     *
     * @param {GLTF.Primitive[]} primitives
     * @returns {Promise<THREE.BufferGeometry[]>}
     */
     ...
     * @returns {Promise<THREE.Group | THREE.Mesh | THREE.SkinnedMesh>}
     */
